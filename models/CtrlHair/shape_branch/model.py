...
class Generator(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.face_encoder = MaskEncoder(18, 2048, norm=cfg.g_norm, layer_num=7, vae_mode=False,
        ...
        self.face_decoder = MaskDecoder(2048, output_channel=18, norm=cfg.g_norm, layer_num=7)
